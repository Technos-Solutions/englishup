  ...
  return (
    <span className="relative inline-block">
      ...
      {visible && (loading || tooltip) && (
        <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1.5 px-2.5 py-1 bg-gray-900 text-white text-xs rounded-lg whitespace-nowrap z-20 shadow-lg pointer-events-none">
          {loading ? '…' : tooltip}
